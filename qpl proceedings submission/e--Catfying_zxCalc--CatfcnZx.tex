...
as well as 
\begin{equation}
\label{eq:2cell_wire_is_identity}
\raisebox{-2.5em}{%
...
\begin{equation}
\label{diag:TwistCompact_1cells}
\raisebox{-0.8\height}{
...
are the same as in
	\ref{eq:Hor_and_Vert_Composition}. 
For example, 
...
\begin{thm}
	\label{thm:decat_zx_is_dagger_compact}
...
\begin{proof}
	...
	maps from \eqref{diag:TwistCompact_1cells}. 
	...
	The extra relation 
		\eqref{eq:2cell_wire_is_identity} 
	ensures that the 
